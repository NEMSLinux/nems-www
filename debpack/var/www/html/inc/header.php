					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
							  ...
							  <?php if (nems_has_role('admin') && ver('platform')->num != 21) echo '<li><a href="/cockpit/" target="_blank">Cockpit</a></li>'; ?>
							  ...
							  <?php if (nems_has_role('operator') && ver('nems') >= 1.3) echo '<li><a href="/monit/" target="_blank"><em>monit</em> Service Monitor</a></li>'; ?>
						...
						<li class="dropdown" <?php if ($whitelabel->enabled == 1) echo 'style="display:none;"'; ?>>
							...
							<ul class="dropdown-menu">
                						<li><a href="https://patreon.com/nems" target="_blank"><i class="fa fa-fw fa-user"></i> Become a Patron</a></li>
               							<li><a href="https://nemslinux.com/donate/" target="_blank"><i class="fa fa-fw fa-credit-card"></i> Donate</a></li>
